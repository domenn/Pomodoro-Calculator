...
Usage:
  get-pomodori [--pomodoro=<time>] [--from=<time>] [--break=<minutes>] [--long-break=<minutes>]
               [--group=<pomodori>] [--interval] [--json] [--nocolour] [--amount] [--extensive-report] [--transition-seconds=<tr>] <end-time>
...
Options:
  ...
  -t, --transition-seconds=<tr>  extra time for transition between break and work [default: 0].
"""
...
def main():
    ...
    schedule = PomodoroCalculator(
        ...
        transition_seconds=arguments['--transition-seconds']
    ).pomodori_schedule()
